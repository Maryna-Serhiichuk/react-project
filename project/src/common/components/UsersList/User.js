		...
		<div className='user_wrap'>
			<div className='user'>
				...
				<div className='user_item'>
					...
					<div className='user_data'>
						<dl>{props.user.address.street} {props.user.address.city}, {props.user.address.suite}</dl>
						<span>Work</span>
					</div>
				</div>
				<div className='user_item'>
				...
				<div className='user_item'>
					...
					<div className='user_data'>
						<dl>{props.user.company.name}, {props.user.company.catchPhrase}, {props.user.company.bs}</dl>
						<span>Segment</span>
					</div>
				</div>
			</div>
