...
class TodoList extends React.Component {
	...
	taskBeTrue(){
		this.props.taskDone(this.props.todo.id);
	}

	taskBeFalse(){
		this.props.taskNotDone(this.props.todo.id);
	}
			...
			<div className='todo_wrap'>
				<div className='todo'>
					...
					{!this.props.todo.completed &&
						<button className='todo_button todo_buttonTrue' onClick={this.taskBeTrue.bind(this)}>&#10004;</button>
					}

					{this.props.todo.completed &&
						<button className='todo_button todo_buttonFalse' onClick={this.taskBeFalse.bind(this)}>&#10008;</button>
					}
